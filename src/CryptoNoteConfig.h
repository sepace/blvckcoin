...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = e;
...
const char     CRYPTONOTE_NAME[]                             = "blvckcoin";
...
const int      P2P_DEFAULT_PORT                              = 35685;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 35686;
